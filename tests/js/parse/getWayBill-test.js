...
(function (root, factory) {
    ...
    milkman.getWayBill(data, function( getQuoteResult ){
    ...
    //
    //milkman.getWayBill(data1, function( getQuoteResult ){
    //
    //    test('data1', function() {
    ...
    //
    //milkman.getWayBill(data2, function( getQuoteResult ){
    //
    //    test('data2', function() {
    //        equal(getQuoteResult.status, 'failure', JSON.stringify(getQuoteResult));
    //    });
    ...
    //
    //milkman.getWayBill(data3, function( getQuoteResult ){
    //
    //    test('data3', function() {
    //        equal(getQuoteResult.status, 'failure', JSON.stringify(getQuoteResult));
    //    });
    ...
    //
    //milkman.getWayBill(data4, function( getQuoteResult ){
    //
    //    test('data4', function() {
    //        equal(getQuoteResult.status, 'failure', JSON.stringify(getQuoteResult));
    //    });
