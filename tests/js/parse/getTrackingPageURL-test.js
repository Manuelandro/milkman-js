...
(function (root, factory) {
    ...
    data['merchant'] = '0000004';
    data['externalTrackingCode'] = '100093683';

    milkman.getTrackingPageURL(data, function( getQuoteResult ){
    ...
    data1['merchant'] = '0cfdafsdfdsf04';
    data1['externalTrackingCode'] = '100093683';

    milkman.getTrackingPageURL(data1, function( getQuoteResult ){
    ...
    data2['merchant'] = '';
    data2['externalTrackingCode'] = '100093683';

    milkman.getTrackingPageURL(data2, function( getQuoteResult ){
    ...
    data3['merchant'] = '0000004';
    data3['externalTrackingCode'] = '';

    milkman.getTrackingPageURL(data3, function( getQuoteResult ){
    ...
    data4['merchant'] = '0000004';
    data4['externalTrackingCode'] = 'sdfssfrwegfrears';

    milkman.getTrackingPageURL(data4, function( getQuoteResult ){
